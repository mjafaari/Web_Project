...
// var socket = io('http://198.143.183.189', {
//     'query': 'token='
//     // + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Imd1ZXN0MjMiLCJuYW1lIjoiZ3Vlc3QyMyIsImF2YXRhciI6MSwiaWF0IjoxNTY2NDcwNjg0fQ.3pFUW_yys0SmQDydQLfwB8xXpQClsKUeAaQ2xDNNXgU'
...
socket.on('next_question', (res) => {
    ...
    $('#img').attr("src", "data:image/png;base64," + b64(res.question.image.data));
});
